...
@Component({
  selector: 'app-seependingpo-list-print',
  standalone: false,
  templateUrl: './seependingpo-list-print.component.html',
  styleUrls: ['./seependingpo-list-print.component.scss']
})
export class SeependingpoListPrintComponent implements OnInit {
  p: any = 1
  loginUserData: any;
...
searchText: any;
  ...
  getOrdersummery() {
    this.spinner.show();
    // this.getinvoicelistcount1 = JSON.parse(localStorage.getItem('getinvoicelistcount1'));
   // console.log(this.getinvoicelistcount1,'lxx');
