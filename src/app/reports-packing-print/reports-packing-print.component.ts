...
@Component({
  selector: 'app-reports-packing-print',
  standalone: false,
  templateUrl: './reports-packing-print.component.html',
  styleUrls: ['./reports-packing-print.component.scss']
})
export class ReportsPackingPrintComponent implements OnInit {
  ...
  constructor(private globalServicce: GlobalServiceService, private route: ActivatedRoute,) {
    ...
    this.route.queryParams.subscribe(params => {
      if (params['invqhid']) {
        this.globalServicce.postDatawithQueryPar('sup/invoice2/', params['invqhid']).subscribe((respdata: any) => {
