...
@Component({
  selector: 'app-pending-invoices-print',
  standalone: false,
  templateUrl: './pending-invoices-print.component.html',
  styleUrls: ['./pending-invoices-print.component.scss']
})
export class PendingInvoicesPrintComponent implements OnInit {
  loginUserData: any
  SupplierData: any
  supplierdata: any = [] 
  suppliers: any = []
  ...
  getOrdersummery() {
    this.supplierdata = JSON.parse(localStorage.getItem('orders'));

    console.log(this.supplierdata,"print data");
