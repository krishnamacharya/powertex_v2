...
@Component({
  selector: 'app-chaledgerprint',
  standalone: false,
  templateUrl: './chaledgerprint.component.html',
  styleUrls: ['./chaledgerprint.component.scss']
})
export class ChaledgerprintComponent implements OnInit {
  orders: any = [];
  p: any = 1;
  searchText: any;
  loginUserData: any;
