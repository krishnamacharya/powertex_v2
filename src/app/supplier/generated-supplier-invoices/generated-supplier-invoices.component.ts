...
declare var $: any;
@Component({
  selector: 'app-generated-supplier-invoices',
  standalone: false,
  templateUrl: './generated-supplier-invoices.component.html',
  styleUrls: ['./generated-supplier-invoices.component.scss']
})
export class GeneratedSupplierInvoicesComponent implements OnInit {
  loginUserData: any
  supplierdata: any = []
  p: any = 1
  searchText: any
  ...
  uploadMore(data) {
    ...
    if (this.loginUserData.role == 'Admin') {
      ...
      this.route.navigateByUrl('Supplier-Invoice-fileupload?S=Gdc');
    }
