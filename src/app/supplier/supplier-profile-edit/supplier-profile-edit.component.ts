...
export class SupplierProfileEditComponent implements OnInit {
  ...
  constructor(private globalService: GlobalServiceService,private toasterService: ToasterService, private route: Router,
    private routes: ActivatedRoute, private http: HttpClient, private fb: FormBuilder,
...
userData: any = {};
 ...
 // Define fields for cleaner code (label and name)
  mainFields = [
    ...
    { label: 'Module Assign', name: 'module_assign' },
  ];

  businessFields = [
    { label: 'Business Name', name: 'business_name' },
    { label: 'Zone', name: 'zone' },
    { label: 'Office Mobile', name: 'off_mobile' },
    { label: 'Office Email', name: 'off_email' },
    { label: 'GST', name: 'gst' },
    { label: 'PAN', name: 'pan' },
    { label: 'CIN', name: 'cin' },
    { label: 'Turnover', name: 'turnover' },
    { label: 'Account Holder Name', name: 'ac_holdername' },
    { label: 'Bank Account Number', name: 'bankac_number' },
    { label: 'Account Type', name: 'ac_type' },
    { label: 'IFSC Code', name: 'ifsc_code' },
    { label: 'MICR Code', name: 'micr_code' },
    { label: 'Credit Period', name: 'credit_period' },
    { label: 'Payment Terms', name: 'payment_terms' },
    { label: 'Credit Limit', name: 'credit_limit' },
    { label: 'Handling Marketing Manager', name: 'handling_marketing_manager' },
    { label: 'SKU', name: 'sku' },
...
updateSupplier() {
  ...
  const payload = {
    ...
    clientid: this.supplier.clientid,
