...
@Component({
  selector: 'app-track-report-print',
  standalone: false,
  templateUrl: './track-report-print.component.html',
  styleUrls: ['./track-report-print.component.scss']
})
export class TrackReportPrintComponent implements OnInit {
  p: any = 1;
  searchText: any;
  loginUserData: any;
