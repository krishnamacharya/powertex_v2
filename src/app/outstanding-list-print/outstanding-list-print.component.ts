...
@Component({
  selector: 'app-outstanding-list-print',
  standalone: false,
  templateUrl: './outstanding-list-print.component.html',
  styleUrls: ['./outstanding-list-print.component.scss']
})

export class OutstandingListPrintComponent implements OnInit {
  p: any = 1
  loginUserData: any;
  getinvoicelist5: any;
  TotOutstanding: any;
