...
@Component({
  selector: 'app-supplier-invoices-supplier-print',
  standalone: false,
  templateUrl: './supplier-invoices-supplier-print.component.html',
  styleUrls: ['./supplier-invoices-supplier-print.component.scss']
})
export class SupplierInvoicesSupplierPrintComponent implements OnInit {
  loginUserData: any
  SupplierData: any
  orders: any = [] 
  suppliers: any = []
