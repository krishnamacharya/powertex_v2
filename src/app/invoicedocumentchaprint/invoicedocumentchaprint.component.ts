...
@Component({
  selector: 'app-invoicedocumentchaprint',
  standalone: false,
  templateUrl: './invoicedocumentchaprint.component.html',
  styleUrls: ['./invoicedocumentchaprint.component.scss']
})
export class InvoicedocumentchaprintComponent implements OnInit {
  p: any = 1;
  type: any = "";
  url: any
  searchText: any
