...
@Component({
  selector: 'app-dealers-outstanding-print',
  standalone: false,
  templateUrl: './dealers-outstanding-print.component.html',
  styleUrls: ['./dealers-outstanding-print.component.scss']
})
export class DealersOutstandingPrintComponent implements OnInit {
  p: any = 1
  loginUserData: any;
  dealerslist: any;
searchText: string;
  ...
  ngOnInit() {
    this.dealerslist = JSON.parse(localStorage.getItem('dealerslist'));
  ...
  getOrdersummery() {
    this.dealerslist = JSON.parse(localStorage.getItem('dealerslist'));
    console.log(this.dealerslist,'lxx');
   this.spinner.show();
     this.spinner.hide();
  };
