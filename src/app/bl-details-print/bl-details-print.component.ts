...
@Component({
  selector: 'app-bl-details-print',
  standalone: false,
  templateUrl: './bl-details-print.component.html',
  styleUrls: ['./bl-details-print.component.scss']
})
export class BlDetailsPrintComponent implements OnInit {
downloadINV(arg0: any,arg1: any) {
throw new Error('Method not implemented.');
}
downloadBL(arg0: any,arg1: any) {
throw new Error('Method not implemented.');
}
downloadPL(arg0: any,arg1: any) {
throw new Error('Method not implemented.');
}
  p: any = 1
  searchText: any;
  loginUserData: any;
  supplierdata: any = [];
  constructor(private DatePipe: DatePipe,private router: Router, private route: Router, private dialog: MatDialog, private spinner: NgxSpinnerService) { }
