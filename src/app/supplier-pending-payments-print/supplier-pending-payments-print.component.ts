...
@Component({
  selector: 'app-supplier-pending-payments-print',
  standalone: false,
  templateUrl: './supplier-pending-payments-print.component.html',
  styleUrls: ['./supplier-pending-payments-print.component.scss']
})
export class SupplierPendingPaymentsPrintComponent implements OnInit {
  loginUserData: any;
  searchText:any;
  PendingPayments: any = [];
