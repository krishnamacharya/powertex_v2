...
@Component({
  selector: 'app-onportsummaryprint',
  standalone: false,
  templateUrl: './onportsummaryprint.component.html',
  styleUrls: ['./onportsummaryprint.component.scss']
})
export class OnportsummaryprintComponent implements OnInit {
