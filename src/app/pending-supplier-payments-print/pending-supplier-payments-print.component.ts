...
@Component({
  selector: 'app-pending-supplier-payments-print',
  standalone: false,
  templateUrl: './pending-supplier-payments-print.component.html',
  styleUrls: ['./pending-supplier-payments-print.component.scss']
})
export class PendingSupplierPaymentsPrintComponent implements OnInit {
  p: any = 1
  loginUserData: any;
  supplierdata: any;
  totaldue: any;
  ...
  getOrdersummery() {
    this.supplierdata = JSON.parse(localStorage.getItem('supplierdata'));
    console.log(this.supplierdata,'lxx');
