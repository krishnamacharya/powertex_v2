...
@Component({
  selector: 'app-seeinvoice-list-print',
  standalone: false,
  templateUrl: './seeinvoice-list-print.component.html',
  styleUrls: ['./seeinvoice-list-print.component.scss']
})
export class SeeinvoiceListPrintComponent implements OnInit {
...
searchText: any;
  ...
  ngOnInit() {
    this.spinner.show();
    this.getinvoicelist4 = JSON.parse(localStorage.getItem('getinvoicelist4'));
 ...
 //   this.getOrdersummery();
  ...
  getOrdersummery() {
    this.spinner.show();
    // this.getinvoicelistcount1 = JSON.parse(localStorage.getItem('getinvoicelistcount1'));
  //  console.log(this.getinvoicelist4,'lxx');
