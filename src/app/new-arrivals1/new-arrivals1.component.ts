...
@Component({
  selector: 'app-new-arrivals1',
  standalone: false,
  templateUrl: './new-arrivals1.component.html',
  styleUrl: './new-arrivals1.component.scss'
})
export class NewArrivals1Component {
  Page: any = 1;
  category: any;
  sub_c: any;
  sub: any;
...
selectedBrands: any[] = [];
  ...
  ngOnInit() {
  this.getNewArrivals1()
  }

 
  getNewArrivals1(): void {
    this.service.getNewArrivals1().subscribe((data: any) => {
