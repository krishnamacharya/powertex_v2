...
@Component({
  selector: 'app-supplier-paidlist-print',
  standalone: false,
  templateUrl: './supplier-paidlist-print.component.html',
  styleUrls: ['./supplier-paidlist-print.component.scss']
})
export class SupplierPaidlistPrintComponent implements OnInit {
  loginUserData: any
  SupplierData: any
  orders: any = [] 
  suppliers: any = []
