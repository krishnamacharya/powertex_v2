...
@Component({
  selector: 'app-admin-consolidate-packing',
  standalone: false,
  templateUrl: './admin-consolidate-packing.component.html',
  styleUrls: ['./admin-consolidate-packing.component.scss']
})
export class AdminConsolidatePackingComponent implements OnInit {
  loginUserData: any
  productdata: any = []
  invoicedata: any
  pro: any = {}
