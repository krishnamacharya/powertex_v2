...
@Component({
  selector: 'app-pending-duty-list-print',
  standalone: false,
  templateUrl: './pending-duty-list-print.component.html',
  styleUrls: ['./pending-duty-list-print.component.scss']
})
export class PendingDutyListPrintComponent implements OnInit {
  loginUserData: any;
  orders: any = [];
searchText: any;
