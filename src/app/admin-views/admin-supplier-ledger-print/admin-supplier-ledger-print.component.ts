...
@Component({
  selector: 'app-admin-supplier-ledger-print',
  standalone: false,
  templateUrl: './admin-supplier-ledger-print.component.html',
  styleUrls: ['./admin-supplier-ledger-print.component.scss']
})
export class AdminSupplierLedgerPrintComponent implements OnInit {
  loginUserData: any;
  suppliers: any;
  orders: any;
  totalinvoice: any;
