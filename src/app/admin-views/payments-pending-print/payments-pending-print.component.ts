...
@Component({
  selector: 'app-payments-pending-print',
  standalone: false,
  templateUrl: './payments-pending-print.component.html',
  styleUrls: ['./payments-pending-print.component.scss']
})
export class PaymentsPendingPrintComponent implements OnInit {
  loginUserData: any
  PendingPayments: any = [];
  p: any = 1;
  searchText:any;
  ...
  ngOnInit() {
    ...
    this.PendingPayments = JSON.parse(localStorage.getItem('orders'));
