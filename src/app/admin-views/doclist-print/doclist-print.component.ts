...
@Component({
  selector: 'app-doclist-print',
  standalone: false,
  templateUrl: './doclist-print.component.html',
  styleUrls: ['./doclist-print.component.scss']
})
export class DoclistPrintComponent implements OnInit {
opentab(arg0: any) {
