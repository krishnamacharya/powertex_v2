...
@Component({
  selector: 'app-duty-paid-report-print',
  standalone: false,
  templateUrl: './duty-paid-report-print.component.html',
  styleUrls: ['./duty-paid-report-print.component.scss']
})
export class DutyPaidReportPrintComponent implements OnInit {
  loginUserData: any;
  dischargeports: any;
  orders: any;
  totalinvoice: any;
