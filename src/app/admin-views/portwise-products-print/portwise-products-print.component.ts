...
@Component({
  selector: 'app-portwise-products-print',
  standalone: false,
  templateUrl: './portwise-products-print.component.html',
  styleUrls: ['./portwise-products-print.component.scss']
})
export class PortwiseProductsPrintComponent implements OnInit {
  loginUserData: any
  SupplierData: any
  orders: any = [] 
  suppliers: any = []
