...
@Component({
  selector: 'app-seepacking-list-print',
  standalone: false,
  templateUrl: './seepacking-list-print.component.html',
  styleUrls: ['./seepacking-list-print.component.scss']
})
export class SeepackingListPrintComponent implements OnInit {
  p: any = 1
  loginUserData: any;
  getpackinglist3: any;
searchText: any;
  ...
  ngOnInit() {
    this.spinner.show();
    this.getpackinglist3 = JSON.parse(localStorage.getItem('getpackinglist3'));
  ...
  getOrdersummery() {
   ...
   // console.log(this.getpackinglist3,'lxx');
